...
| --- | --- | --- |
| **C# 1.0** | 2002 | Core object-oriented features ( [classes](https://github.com/CristianSifuentes/typesOfClassesCSh), inheritance, [interfaces](https://github.com/CristianSifuentes/abstract-classes-vs-interfaces-csh)      ). |
